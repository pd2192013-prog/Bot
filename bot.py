...
---------------------------------------------------------
Ye ek single file hai jisme requirements bhi embedded hain.
Jab is file ko run karoge, ye pehle zaroori packages check/install
karega, phir bot start karega.
...
def ensure_requirements():
    """Install any missing packages listed in REQUIREMENTS."""
    import importlib

    # module import name -> pip package name (jaha dono alag hain)
    check_map = {
    ...
    missing = []
    for module_name, pip_name in check_map.items():
        try:
...
# ---------- Actual bot code (ab yaha se safe imports honge) ----------
import logging
import os
